...
# Permitir que el servicio de logging de S3 escriba en el bucket de logs
data "aws_caller_identity" "current" {}

resource "aws_s3_bucket_policy" "media_logs_write" {
  bucket = aws_s3_bucket.media_logs.id
    ...
    Statement = [
      {
        ...
        Resource  = [aws_s3_bucket.media_logs.arn, "${aws_s3_bucket.media_logs.arn}/*"]
        Condition = {
          StringEquals = {
